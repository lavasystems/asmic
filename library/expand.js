...
dc={
	...
	// CSS class names
	trigger:'m2_trigger',
	triggeropen:'m2_expanded',
	hideClass:'m2_hide',
	showClass:'m2_show',

	// pictures and text alternatives
	closedPic:'../images/m2/m2_btn_clickabstract.gif',
	closedAlt:'Expand Abstract',
	openPic:'../images/m2/m2_btn_closeabstract.gif',
	openAlt:'Collapse Abstract',
	...
	addCollapse:function(e){
		...
		if(dc.uniqueCollapse && dc.currentOpen){
			...
			dc.currentOpen.getElementsByTagName('img')[0].setAttribute('border',0);
		...
		if(o.tohide){
			if(dc.cssjs('check',o.tohide,dc.hideClass)){
				...
				o.getElementsByTagName('img')[0].setAttribute('border',0);
			...
			dc.currentOpen=o;
			dc.cancelClick(e);
			if(document.getElementById('debug') != null){ //Added by Chia Boon 05-July-2006 2.30PM
