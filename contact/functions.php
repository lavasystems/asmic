...
<HTML>
<HEAD>
<TITLE>ASMIC Contact Management - Access Denied</TITLE>
...
?>
	...
	<div class="ar11_content"><?php echo($msg); ?></div>
	<p><font class="ar11_content">If necessary, please press the BACK button on your browser to return to the previous screen and correct any possible mistakes.</font>
	<p>
	</td>
	</tr>
	</table>
	...
	<td>
	<br>
	<a href="javascript:history.go(-1)"><img src="../images/m5/m5_btn_back.gif" border="0"></a>
	</td>
	</tr>
	<tr>
	<td>&nbsp;</td>
...
<html>
<head>
	<title>ASMIC Contact Management - Error</title>
	<link rel="stylesheet" href="styles.css" type="text/css">
	<meta http-equiv="CACHE-CONTROL" content="NO-CACHE">
	<meta http-equiv="PRAGMA" content="NO-CACHE">
	<meta http-equiv="EXPIRES" content="-1">
